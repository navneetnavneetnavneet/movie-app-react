...
const TvDetails = () => {
  ...
  return info ? (
    ...
    >
      ...
      <div className="text-zinc-100 my-5 w-full">
        <h1 className="text-3xl font-bold mb-5">Seasons</h1>
        <div className="w-full whitespace-nowrap flex gap-x-10 overflow-x-auto overflow-y-hidden">
          {info.detail.seasons.length > 0 ? (
            info.detail.seasons.map((s, idx) => (
              <div
                key={idx}
                className="w-[15%] h-fit flex-shrink-0 bg-zinc-900 text-white mb-3"
              >
